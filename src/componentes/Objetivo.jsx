...
const Objetivo = () => {
    return (
        <div className={styles.corpoDesc}>
            ...
            <h3>SENAC/MG – Representante Comercial</h3>
            ...
            <h3>IFNMG - Instituto Federal de Educação Ciência e Tecnologia de Minas Gerais</h3>
            ...
            <p className={styles.pDesc}>Não concluído 2013 - 2015</p>


            
            <h3>ENSINO MÉDIO COMPLETO</h3>
            <p className={styles.periodo}>1/2005 – 12/2007</p>
            <p className={styles.pDesc}>Conclusão do Ensino médio do ensino Básico</p>




            
            <h3>TÉCNICO AGROPECUÁRIO</h3>
            <p className={styles.periodo}>1/2005 – 12/2006</p>
            <p className={styles.pDesc}>Curso técnico em conjunto com o ensino médio – <strong>Falta estágio para conclusão</strong>.</p>

            <h2>EXPERIÊNCIAS PROFISSIONAIS</h2>

            <h3>Brasil Gôndolas LTDA</h3>
            <p className={styles.periodo}>jun. de 2022 – até o presente momento - 3 meses
            Canoas, Rio Grande do Sul, Brasil</p>
            ...
            <h3>AGENTE DE DESENVOLVIMENTO ECONÔMICO</h3>
            <p className={styles.periodo}>jun. de 2017 – até junho de 2022 - 5 anos
